...
import { useAnimeEp2d } from "@/hooks/useAnime"
import { AnimationCard } from "@/components/animation-card"
import Loading from "@/app/loading"
import MVLink from "@/components/Link"

export function Ep2d() {
  const { data: animeData, isLoading } = useAnimeEp2d();
  ...
  return (
    <section className="mb-12">
      <div className="flex items-center justify-between mb-6">
        ...
        <MVLink href="/ep-2d" className="flex items-center text-sm text-primary hover:underline">
